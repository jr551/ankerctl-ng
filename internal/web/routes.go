...
func (s *Server) registerRoutes() {
	...
	r.Get("/api/printer/runtime-state", h.PrinterRuntimeState)
	r.Get("/api/printer/settings-summary", h.PrinterSettingsSummary)
	r.Get("/api/printer/alerts", h.PrinterAlerts)
